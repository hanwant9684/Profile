...
async def download_media_fast(client: Client, message, file_name, progress_callback=None):
    ...
    if not media:
        return await message.download(file_name, progress=progress_callback)
